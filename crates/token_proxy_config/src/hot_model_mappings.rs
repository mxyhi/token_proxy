...
const DEFAULT_HOT_MODEL_MAPPING_PAIRS: &[(&str, &str)] = &[
    ...
    // Opus 5.5 官方 ID 是 claude-opus-5-5；点号写法对齐 opus-4.8。
    ...
    ("x-ai/grok-4.6-high", "grok-4.6"),
    ("xai/grok-4.6-high", "grok-4.6"),
    ("x-ai/grok-4.6-xhigh", "grok-4.6"),
    ("xai/grok-4.6-xhigh", "grok-4.6"),
    ("x-ai/grok-4.6xhigh", "grok-4.6"),
    ("xai/grok-4.6xhigh", "grok-4.6"),
