...
#[derive(Clone)]
pub(crate) struct AntigravityLoginManager {
...
impl AntigravityLoginManager {
    pub(crate) fn new(store: Arc<AntigravityAccountStore>, app_proxy: AppProxyState) -> Self {
        Self {
            store,
    ...
    pub(crate) async fn start_login(&self) -> Result<AntigravityLoginStartResponse, String> {
