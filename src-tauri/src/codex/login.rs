...
#[derive(Clone)]
pub(crate) struct CodexLoginManager {
...
impl CodexLoginManager {
    pub(crate) fn new(store: Arc<CodexAccountStore>, app_proxy: AppProxyState) -> Self {
        Self {
            store,
    ...
    pub(crate) async fn start_login(&self) -> Result<CodexLoginStartResponse, String> {
    ...
    pub(crate) async fn poll_login(&self, state: &str) -> Result<CodexLoginPollResponse, String> {
    ...
    pub(crate) async fn logout(&self, account_id: &str) -> Result<(), String> {
